<template>
	<section class="el-tabs-body">
		<el-button type="primary" @click="exportClick">导出为docx文件</el-button>
		<h1 class="abc"
...
const exportClick = () => {
    var el = document.querySelector('.el-tabs-body')?.innerHTML;
    // var content = JSON.stringify(el);
    var content = el;
    // var content = '<h1>This is an about page</h1><h2>This is an about page</h2>'
    console.log(111, content);
    var page = `<!DOCTYPE html><html><head><meta charset="UTF-8"></head><body>${el}</body></html>`;
    console.log(page);
