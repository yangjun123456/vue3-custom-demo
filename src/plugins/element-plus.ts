...
if (toNumber(elStyleType) == 1) {
    // 第一种样式
    import('@/assets/style/element-ui/element-ui-base-1.scss');
    import('@/assets/style/element-ui/element-ui-variable-1.scss');
}

if (toNumber(elStyleType) == 2) {
    // 第二种样式
    import('@/assets/style/element-ui/element-ui-base-2.scss');
    import('@/assets/style/element-ui/element-ui-variable-2.scss');
}
