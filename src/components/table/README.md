...
10. 表格自动适应高度直到撑满容器 === .table-wraper height:100% + tableHeight auto

11. 表格默认撑满整个容器， 分页始终在最下方 === .table-wraper height:100% + tableHeight 100%

12. 表格不出现滚动条， 有多高显示多高 === .table-wraper height:auto + (tableHeight auto||tableHeight 100%)
